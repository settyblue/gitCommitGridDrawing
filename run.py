...
def get_daily_quotation(quote_number):
    ...
    print str(soup.findAll("div",{"class":"td-excerpt"})[quote_number+2].contents[0]).replace('&#039;', '\'')
    return str(soup.findAll("div",{"class":"td-excerpt"})[quote_number+2].contents[0]).replace('&#039;', '\'')
